            ...
            <div className="w-full flex-1">
                ...
                <div className="w-full h-[50%] flex items-center justify-center bg-zinc-900/20 border-l border-zinc-900">
                    <div className="relative w-64 h-64 flex items-center justify-center">
                        <div className="absolute w-full h bg-zinc-800"></div>
                        <div className="absolute h-full w bg-zinc-800"></div>
                        
                        <div className="absolute w-32 h-32 border border-zinc-800 rounded-full"></div>
                        <div className="absolute w-64 h-64 border border-zinc-800 rounded-full"></div>

                        <span className="absolute top-0 text-[10px] text-zinc-600 font-mono">LONG +</span>
                        <span className="absolute right-0 text-[10px] text-zinc-600 font-mono">LAT +</span>
