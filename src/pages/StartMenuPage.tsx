...
function MenuButton({label, onClick}: MenuButtonProps) {
    return(
        <button onClick={onClick} className='w-85 h-20 flex flex-row items-center justify-center bg-[rgb(0, 0, 0)] border border-border-1-dark font-mono tracking-widest uppercase text-text-1-dark hover:bg-bg-hover-1-dark active:border-white active:bg-bg-active-1-dark'>
            {label}
        </button>
    );
}
...
export default function StartMenuPage({ onOpenSettings }: StartMenuPageProps) {
    ...
    return(
        <div className='w-screen h-screen absolute flex flex-col z-0'>
            <div className='h-20 flex flex-row items-center justify-end bg-bg-1-dark'>
            ...
            <div className='flex flex-col flex-1 items-center justify-center gap-3 bg-bg-1-dark'>
